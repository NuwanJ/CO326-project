...
#define cpu_map_h
  ...
  #define Y_STEP_BIT    4 // 3 // MEGA2560 Digital Pin 25
  #define Z_STEP_BIT    3 // 4 // MEGA2560 Digital Pin 26
  ...
  #define Y_DIRECTION_BIT   5 // 6 // MEGA2560 Digital Pin 31
  #define Z_DIRECTION_BIT   6 // 5 // MEGA2560 Digital Pin 32
  ...
  #define STEP_PORT_1 L //F
  #define STEP_PORT_2 F //L
  #if N_AXIS > 3
  ...
  #define STEP_BIT_1 3 //6  // Y Step - Pin A6
  #define STEP_BIT_2 6 //3  // Z Step - Pin D46
  #if N_AXIS > 3
  ...
  #define DIRECTION_PORT_1 L // F
  #define DIRECTION_PORT_2 F // L
  #if N_AXIS > 3
  ...
  #define DIRECTION_BIT_1 1 // 7 // Y Dir - Pin A7
  #define DIRECTION_BIT_2 7 //1 // Z Dir - Pin D48
  #if N_AXIS > 3
